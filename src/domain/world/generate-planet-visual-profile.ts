...
export function generateCanonicalPlanet(input: PlanetSeedInput): CanonicalPlanet {
  ...
  const render: PlanetRenderProfile = {
    ...
    clouds: {
      ...
      coverage: clamp(visualDNA.cloudCoverage * 0.55, 0.08, 0.42),
      opacity: clamp(visualDNA.cloudCoverage * 0.32, 0, 0.35),
      speed: visualDNA.rotation.cloudSpeed * 0.5,
    ...
    rings: {
      ...
      opacity: generated.ring.opacity * 0.45,
