    ...
    palettes: [
      {
        ...
        mid: [0.16, 0.44, 0.12],
        high: [0.48, 0.40, 0.22],
        ocean: [0.02, 0.06, 0.18],
        accent: [0.82, 0.76, 0.52],
        cloud: [0.94, 0.96, 1.0],
        atmosphere: [0.32, 0.56, 0.88],
        ring: [0.68, 0.64, 0.56],
      },
      {
        id: 'lush-boreal',
        ...
        mid: [0.13, 0.36, 0.11],
        high: [0.42, 0.36, 0.24],
        ocean: [0.01, 0.05, 0.15],
        accent: [0.74, 0.70, 0.58],
        cloud: [0.93, 0.95, 0.98],
        atmosphere: [0.36, 0.58, 0.86],
        ring: [0.7, 0.69, 0.62],
      },
    ],
  },
    ...
    palettes: [
      {
        ...
        mid: [0.03, 0.12, 0.32],
        high: [0.12, 0.38, 0.54],
        ocean: [0.01, 0.05, 0.16],
        accent: [0.72, 0.84, 0.90],
        cloud: [0.92, 0.96, 1.0],
        atmosphere: [0.28, 0.52, 0.90],
        ring: [0.62, 0.75, 0.84],
      },
      {
        id: 'ocean-cobalt',
        ...
        accent: [0.68, 0.80, 0.92],
        cloud: [0.9, 0.94, 0.98],
        atmosphere: [0.24, 0.48, 0.84],
        ring: [0.65, 0.78, 0.88],
      },
    ],
  },
    ...
    palettes: [
      {
        ...
        mid: [0.60, 0.38, 0.16],
        high: [0.80, 0.64, 0.36],
        ocean: [0.16, 0.13, 0.09],
        accent: [0.90, 0.80, 0.56],
        cloud: [0.86, 0.80, 0.70],
        atmosphere: [0.82, 0.56, 0.28],
        ring: [0.76, 0.65, 0.47],
      },
      {
        id: 'arid-mineral',
        ...
        mid: [0.54, 0.34, 0.18],
        high: [0.70, 0.54, 0.32],
        ocean: [0.15, 0.12, 0.09],
        accent: [0.86, 0.76, 0.54],
        cloud: [0.84, 0.79, 0.72],
        atmosphere: [0.78, 0.52, 0.24],
        ring: [0.74, 0.62, 0.5],
      },
    ],
  },
    ...
    palettes: [
      {
        ...
        mid: [0.56, 0.70, 0.82],
        high: [0.86, 0.91, 0.97],
        ocean: [0.02, 0.08, 0.22],
        accent: [0.72, 0.86, 0.96],
        cloud: [0.93, 0.96, 1.0],
        atmosphere: [0.48, 0.68, 0.94],
        ring: [0.82, 0.9, 0.96],
      },
      {
        id: 'ice-cyan',
        ...
        mid: [0.50, 0.65, 0.80],
        high: [0.82, 0.90, 0.97],
        ocean: [0.01, 0.06, 0.20],
        accent: [0.68, 0.84, 0.97],
        cloud: [0.94, 0.97, 1.0],
        atmosphere: [0.42, 0.62, 0.92],
        ring: [0.84, 0.92, 0.98],
      },
    ],
  },
    ...
    palettes: [
      {
        ...
        mid: [0.14, 0.09, 0.07],
        high: [0.30, 0.16, 0.09],
        ocean: [0.07, 0.05, 0.04],
        accent: [0.96, 0.38, 0.08],
        cloud: [0.42, 0.34, 0.30],
        atmosphere: [0.78, 0.28, 0.12],
        ring: [0.63, 0.35, 0.21],
      },
      {
        id: 'infernal-sulfur',
        ...
        mid: [0.16, 0.12, 0.06],
        high: [0.34, 0.20, 0.08],
        ocean: [0.06, 0.05, 0.04],
        accent: [0.98, 0.48, 0.10],
        cloud: [0.48, 0.38, 0.28],
        atmosphere: [0.82, 0.32, 0.12],
        ring: [0.67, 0.38, 0.2],
      },
    ],
  },
    ...
    palettes: [
      {
        ...
        mid: [0.20, 0.40, 0.08],
        high: [0.42, 0.54, 0.12],
        ocean: [0.04, 0.14, 0.03],
        accent: [0.72, 0.94, 0.24],
        cloud: [0.74, 0.84, 0.62],
        atmosphere: [0.48, 0.74, 0.22],
        ring: [0.58, 0.72, 0.36],
      },
      {
        id: 'toxic-violet',
        ...
        mid: [0.32, 0.18, 0.40],
        high: [0.48, 0.30, 0.56],
        ocean: [0.10, 0.06, 0.16],
        accent: [0.32, 0.92, 0.74],
        cloud: [0.76, 0.72, 0.86],
        atmosphere: [0.48, 0.34, 0.82],
        ring: [0.62, 0.53, 0.86],
      },
    ],
  },
...
function buildViewProfile(viewMode: PlanetViewProfile['viewMode']): PlanetViewProfile {
  ...
  return {
    ...
    cloudSegments: isGalaxy ? 28 : 96,
    atmosphereSegments: isGalaxy ? 24 : 84,
