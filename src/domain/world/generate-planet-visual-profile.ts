    ...
    palettes: [
      {
        ...
        mid: [0.22, 0.31, 0.18],
        high: [0.38, 0.44, 0.28],
        ocean: [0.05, 0.10, 0.07],
        accent: [0.62, 0.72, 0.42],
        cloud: [0.74, 0.80, 0.66],
        atmosphere: [0.40, 0.62, 0.30],
        ring: [0.56, 0.66, 0.42],
      },
      {
        id: 'toxic-violet',
        ...
        mid: [0.28, 0.20, 0.31],
        high: [0.42, 0.31, 0.44],
        ocean: [0.09, 0.06, 0.11],
        accent: [0.50, 0.68, 0.62],
        cloud: [0.74, 0.72, 0.82],
        atmosphere: [0.44, 0.36, 0.68],
        ring: [0.60, 0.54, 0.76],
      },
    ],
  },
...
function buildViewProfile(viewMode: PlanetViewProfile['viewMode']): PlanetViewProfile {
  ...
  return {
    ...
    meshSegments: isGalaxy ? 12 : 172,
    cloudSegments: isGalaxy ? 0 : 0,
    atmosphereSegments: isGalaxy ? 0 : 0,
    ringSegments: isGalaxy ? 72 : 320,
    enableRings: true,
    enableClouds: false,
    enableAtmosphere: false,
    enableOceanLayer: false,
    lightingBoost: isGalaxy ? 1.46 : 1.62,
    shadingContrast: isGalaxy ? 0.31 : 0.44,
  };
}
