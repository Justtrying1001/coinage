...
export const PLANET_ARCHETYPES: ArchetypeConfig[] = [
  {
    ...
    hydrology: { oceanBias: { min: 0.58, max: 0.82 }, minLandRatio: { min: 0.46, max: 0.58 }, maxOceanRatio: { min: 0.48, max: 0.58 } },
  ...
  },
  {
    ...
    hydrology: { oceanBias: { min: 0.26, max: 0.48 }, minLandRatio: { min: 0.5, max: 0.62 }, maxOceanRatio: { min: 0.4, max: 0.52 } },
  ...
  },
  {
    ...
    hydrology: { oceanBias: { min: 0.28, max: 0.52 }, minLandRatio: { min: 0.54, max: 0.68 }, maxOceanRatio: { min: 0.34, max: 0.5 } },
  ...
  },
  {
    ...
    hydrology: { oceanBias: { min: 0.34, max: 0.54 }, minLandRatio: { min: 0.5, max: 0.64 }, maxOceanRatio: { min: 0.38, max: 0.52 } },
  ...
  },
  {
    ...
    hydrology: { oceanBias: { min: 0.18, max: 0.46 }, minLandRatio: { min: 0.52, max: 0.66 }, maxOceanRatio: { min: 0.32, max: 0.48 } },
  ...
  },
  {
    ...
    hydrology: { oceanBias: { min: 0.08, max: 0.34 }, minLandRatio: { min: 0.56, max: 0.72 }, maxOceanRatio: { min: 0.26, max: 0.42 } },
  ...
  },
  {
    ...
    hydrology: { oceanBias: { min: 0.26, max: 0.46 }, minLandRatio: { min: 0.6, max: 0.76 }, maxOceanRatio: { min: 0.28, max: 0.44 } },
