...
import { WikiBreadcrumb, WikiCallout, WikiCategoryCard, WikiLanding, WikiLayout, WikiPageHeader, WikiPrevNext, WikiRelatedPages, WikiSidebar, WikiSystemCard, WikiTableOfContents } from '@/components/wiki/WikiComponents';
...
export default async function WikiPage({ params }: { params: Promise<{ slug?: string[] }> }) {
  ...
  return <main className="wiki-shell wiki-detail"><WikiBreadcrumb category={page.category} title={page.title} />
    <WikiLayout left={<WikiSidebar pages={categoryPages} current={page.publicPath} />} main={<div className="wiki-article"><WikiPageHeader title={page.title} description={page.description} status={page.status} tags={page.tags} />
      ...
      </div>} right={<WikiTableOfContents items={toc} />} />
  </main>;
}
