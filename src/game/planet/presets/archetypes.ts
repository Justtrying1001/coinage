...
const BASE_PRESETS: Record<PlanetArchetype, PlanetArchetypePreset> = {
  ...
  arid: {
    ...
    surface: {
      elevationGradient: [s(0, [0.4, 0.29, 0.19]), s(0.18, [0.52, 0.38, 0.23]), s(0.44, [0.63, 0.48, 0.29]), s(0.7, [0.68, 0.53, 0.34]), s(0.88, [0.59, 0.44, 0.3]), s(1, [0.77, 0.68, 0.54])],
  ...
  volcanic: {
    ...
    surface: {
      elevationGradient: [s(0, [0.04, 0.04, 0.05]), s(0.28, [0.08, 0.07, 0.07]), s(0.54, [0.14, 0.11, 0.1]), s(0.78, [0.22, 0.16, 0.12]), s(0.92, [0.31, 0.2, 0.13]), s(1, [0.4, 0.25, 0.16])],
      ...
      hotspotCoverage: 0.16,
      hotspotIntensity: 0.86,
      fissureScale: 30,
      fissureSharpness: 4.8,
      lavaAccentStrength: 0.66,
  ...
  barren: {
    ...
    surface: {
      elevationGradient: [s(0, [0.29, 0.25, 0.22]), s(0.24, [0.4, 0.34, 0.29]), s(0.56, [0.48, 0.4, 0.34]), s(0.82, [0.57, 0.5, 0.44]), s(1, [0.68, 0.62, 0.56])],
      ...
      microReliefStrength: 0.26,
      microReliefScale: 19,
      microNormalStrength: 0.09,
      microAlbedoBreakup: 0.12,
      hotspotCoverage: 0.05,
