...
const BASE_PRESETS: Record<PlanetArchetype, PlanetArchetypePreset> = {
  ...
  frozen: {
    ...
    surface: {
      elevationGradient: [s(0, [0.58, 0.69, 0.75]), s(0.28, [0.67, 0.78, 0.84]), s(0.52, [0.75, 0.84, 0.9]), s(0.78, [0.86, 0.91, 0.96]), s(1, [0.95, 0.97, 0.99])],
      depthGradient: [s(0, [0.34, 0.45, 0.56]), s(0.44, [0.43, 0.57, 0.68]), s(0.76, [0.56, 0.69, 0.79]), s(1, [0.7, 0.82, 0.9])],
      blendDepth: 0.013,
  ...
  volcanic: {
    ...
    surface: {
      elevationGradient: [s(0, [0.05, 0.05, 0.06]), s(0.26, [0.11, 0.1, 0.1]), s(0.5, [0.19, 0.16, 0.14]), s(0.74, [0.3, 0.22, 0.16]), s(0.9, [0.42, 0.28, 0.18]), s(1, [0.56, 0.36, 0.22])],
      depthGradient: [s(0, [0.01, 0.01, 0.02]), s(0.42, [0.04, 0.04, 0.05]), s(0.72, [0.09, 0.07, 0.06]), s(1, [0.16, 0.1, 0.07])],
      blendDepth: 0.008,
