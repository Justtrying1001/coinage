...
export const CITY_BIOME_SPECS: Record<PlanetArchetype, CityBiomeSpec> = {
  oceanic: {
    ...
    buildArea: { widthPct: 0.7, depthPct: 0.6, flatten: 0.92, height: -1.8 },
  ...
  frozen: {
    ...
    buildArea: { widthPct: 0.68, depthPct: 0.56, flatten: 0.9, height: -0.9 },
    materialMode: 'heightBlend',
  ...
  arid: {
    ...
    buildArea: { widthPct: 0.72, depthPct: 0.6, flatten: 0.93, height: -0.6 },
    materialMode: 'heightBlend',
  ...
  volcanic: {
    ...
    buildArea: { widthPct: 0.64, depthPct: 0.54, flatten: 0.86, height: -1.4 },
    materialMode: 'heightBlend',
  ...
  mineral: {
    ...
    buildArea: { widthPct: 0.7, depthPct: 0.58, flatten: 0.92, height: -1 },
    materialMode: 'heightBlend',
  ...
  terrestrial: {
    ...
    buildArea: { widthPct: 0.74, depthPct: 0.62, flatten: 0.95, height: -0.2 },
    materialMode: 'heightBlend',
  ...
  jungle: {
    ...
    buildArea: { widthPct: 0.72, depthPct: 0.6, flatten: 0.93, height: -0.1 },
    materialMode: 'heightBlend',
  ...
  barren: {
    ...
    buildArea: { widthPct: 0.7, depthPct: 0.58, flatten: 0.92, height: -0.7 },
    materialMode: 'heightBlend',
