...
export const FULL_BUILDING_CATALOG: BuildingCatalogEntry[] = [
  ...
  },
  {
    ...
    gameplayImplemented: true,
    maxLevel: 35,
    role: 'Research unlock gate + city research points capacity (4 RP per level) with one active timed research queue.',
    ...
    operationalEffectsByBand: [
      { minLevel: 1, maxLevel: 35, effects: ['Research Capacity +4 per level'] },
    ],
    notes: [
      'Runtime enforces one active research at a time with timed completion and queue resolution.',
      'Research guards enforce lab-level gates, research prerequisites, RP capacity, and resource costs.',
    ],
  },
  {
    id: 'market',
    ...
    gameplayImplemented: true,
    maxLevel: 30,
    role: 'Resource transfer capacity building; determines per-dispatch shipment cap.',
    primarySystems: ['resource_transfer', 'shipment_capacity', 'city_ui'],
    unlock: [
      { type: 'hq', targetId: 'hq', minLevel: 3 },
      { type: 'building', targetId: 'warehouse', minLevel: 5 },
    ],
    ...
    operationalEffectsByBand: [
      { minLevel: 1, maxLevel: 30, effects: ['shipmentCapacity +500 per level (L1=500 to L30=15000)'] },
    ],
    notes: [
      'Construction/upgrade/runtime effect wiring is live in city economy systems.',
...
export const FULL_UNIT_CATALOG: UnitCatalogEntry[] = [
  ...
  },
  {
    ...
    definitionStatus: 'fully_defined',
    gameplayImplemented: true,
    role: 'Heavy assault / anti-structure pressure line unit.',
