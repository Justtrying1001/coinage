...
export class CitySceneController {
  ...
  constructor(
    ...
    this.camera = new PerspectiveCamera(46, 1, 0.1, 1100);
    this.camera.position.set(-36, 58, 92);
    this.camera.lookAt(new Vector3(8, 18, -24));
