...
| `building.watch_tower.card` / `building.watch_tower.tile` | Watch Tower visual | Command card | `CityFoundationMode` | `watch_tower` | card visual | PNG | 256x144 | default | P0 | yes | safe-now | Existing file present. |
