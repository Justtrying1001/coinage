...
| `watch_tower` | Watch Tower | Command building card, defense structures list | card visual | tile visual, list icon, world tile sprite | yes | safe-now | No iso coverage in repo. | Currently points to `/assets/watchtower.png`. |
...
| `intelligence_center` | Intelligence Center | Command building card, intelligence/detail contexts | card visual | tile visual, list icon, world tile sprite | yes | safe-now | No iso coverage in repo. | Currently points to `/assets/spycenter.png`. |
