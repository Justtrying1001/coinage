...
- Recherche requise: rapid_carrier
...
- Bâtiment requis: `space_dock`
- Niveau requis: 1
- Recherche requise éventuelle: rapid_carrier
...
|---|---|---|---:|---:|---:|---:|---:|---:|---:|---|---:|---:|---:|---:|---:|---|
| Rapid Carrier | swift_carrier | naval | 800 | 0 | 400 | 0 | 7200 | 5 | 0 | none | 0 | 0 | 0 | 15 | 10 | Fast transport ship. |

## 4. Rôle gameplay réel
- Transport logistique/naval.
- Interprétation limitée au code: note config présente (`Fast transport ship.`); pas d’extrapolation hors runtime.
...
- Recherche source: rapid_carrier
