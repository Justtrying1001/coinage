...
## Identity
- technical id: `siege_artillery`
- display name: `Siege Artillery`
- type: `unit unlock`
- description: `Unit unlock research.`
- source of truth: `src/game/city/economy/cityEconomyConfig.ts` (`CITY_ECONOMY_CONFIG.research.siege_artillery`)
...
- Unit dependency: training of `siege_breacher` requires this research via troop config.
...
- intention design probable: Unlock unité `siege_breacher` dans la file d'entraînement.
- confidence: `HIGH`

## Current runtime behavior
- runtime consumer(s): canStartTroopTraining -> troop.requiredResearch (siege_breacher)
