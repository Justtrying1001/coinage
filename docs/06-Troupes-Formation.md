...
| assault | Assault | ground | barracks | 1 | fortified_districts | 120 | 0 | 75 | 0 | 1087 | 1 | 8 | distance | 7 | 25 | 13 | 12 | 24 | 0 | Ranged anti-sharp / utility profile. |
| shield_guard | Shield Guard | ground | barracks | 15 | war_protocols | 200 | 440 | 320 | 0 | 4710 | 4 | 56 | sharp | 76 | 16 | 56 | 18 | 64 | 0 | Elite heavy ground unit. |
...
| phalanx_lancer | Phalanx Lancer | barracks | 1 | fortified_districts | 0 | 75 | 150 | 0 | 1316 | 1 | 16 | sharp | 18 | 12 | 7 | 6 | 8 | 0 |
| marksman | Marksman | barracks | 1 | economy_drills | 55 | 100 | 40 | 0 | 1144 | 1 | 23 | distance | 7 | 8 | 2 | 14 | 8 | 0 |
| assault | Assault | barracks | 1 | fortified_districts | 120 | 0 | 75 | 0 | 1087 | 1 | 8 | distance | 7 | 25 | 13 | 12 | 24 | 0 |
| shield_guard | Shield Guard | barracks | 15 | war_protocols | 200 | 440 | 320 | 0 | 4710 | 4 | 56 | sharp | 76 | 16 | 56 | 18 | 64 | 0 |
| raider_cavalry | Raider Cavalry | barracks | 10 | logistics_automation | 240 | 120 | 360 | 0 | 3835 | 3 | 60 | blunt | 18 | 1 | 24 | 22 | 72 | 0 |
| breacher | Breacher | barracks | 5 | war_protocols | 700 | 700 | 700 | 0 | 17662 | 15 | 100 | distance | 30 | 30 | 30 | 2 | 400 | 0 |
...
- **catégorie**: `ground`
- **bâtiment de production**: `barracks`
- **prérequis runtime**: `barracks >= 1` + méta recherche `fortified_districts` (enforcement désactivé pour ce build)
...
- **catégorie**: `ground`
- **bâtiment de production**: `barracks`
- **prérequis runtime**: `barracks >= 1` + méta recherche `economy_drills` (enforcement désactivé pour ce build)
...
- **catégorie**: `ground`
- **bâtiment de production**: `barracks`
- **prérequis runtime**: `barracks >= 15` + méta recherche `war_protocols` (enforcement désactivé pour ce build)
...
- **catégorie**: `ground`
- **bâtiment de production**: `barracks`
- **prérequis runtime**: `barracks >= 10` + méta recherche `logistics_automation` (enforcement désactivé pour ce build)
...
- **catégorie**: `ground`
- **bâtiment de production**: `barracks`
- **prérequis runtime**: `barracks >= 5` + méta recherche `war_protocols` (enforcement désactivé pour ce build)
